...
import com.td.techdotmusicplayer.exo.ExoPlayerManager
import com.td.techdotmusicplayer.exo.OnExoPlayerManagerCallback
import com.td.techdotmusicplayer.notification.PlayerNotificationManager
import java.util.*
...
class SongPlayerService : Service(), OnExoPlayerManagerCallback {
    ...
    fun subscribeToSongPlayerUpdates() {
        ...
        ContextCompat.startForegroundService(
            applicationContext,Intent(this, SongPlayerService::class.java)
        )
    }
